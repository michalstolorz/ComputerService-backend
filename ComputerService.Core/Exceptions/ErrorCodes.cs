namespace ComputerService.Core.Exceptions
{
    public static class ErrorCodes
    {
        ...
        public static string UsedPartAlreadyAssignToRepair => "part_with_given_id_already_assign_to_given_repair";
        ...
        public static string UserWithGivenEmailNotFound => "user_with_given_email_not_found";
